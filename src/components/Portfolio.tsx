const PortfolioSection = () => {
  const portfolioItems = [
    { 
      ...
      description: "A comprehensive school management system with multiple user roles including admin, teachers, and students.",
    ...
    { 
      ...
      description: "Backend REST API built with Django for a school management system with authentication and data management.",
    ...
    { 
      ...
      description: "A modern and responsive portfolio website showcasing my projects and skills as a developer.",
    ...
    { 
      ...
      description: "A blog platform featuring articles on various topics with content management capabilities.",
    ...
    { 
      ...
      title: "Portfolio Design", 
      description: "Another portfolio design showcasing different styling approaches and layout techniques.",
    ...
    { 
      ...
      description: "A professional company website with services, about section, and contact information.",
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {portfolioItems.map((item) => (
            <div key={item.id} className="bg-white rounded-lg overflow-hidden shadow-md transition-transform hover:scale-105">
