...
export default function Footer({ scrollToSection }: FooterProps) {
  return (
    <footer className="bg-josseypink1 text-white py-12">
      <div className="container mx-auto px-6 max-w-6xl grid md:grid-cols-3 gap-8">
        ...
        <div>
          <h2 className="text-lg font-bold mb-4">Copyright 2025</h2>
            ...
            {['home', 'about', 'skills', 'portfolio', 'contact'].map(item => (
              <li key={item}>
                <a 
                  ...
                  className="text-sm hover:underline transition-colors capitalize opacity-80 hover:opacity-100"
                >
                  {item}
                </a>
              </li>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a 
              href="https://twitter.com/josseycodes" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              title="Twitter"
            ...
            <a 
              href="https://instagram.com/josseycodes" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              title="Instagram"
            ...
            <a 
              href="https://wa.me/2348132037553" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
              title="WhatsApp"
          ...
          <p className="text-sm opacity-80 mt-4">Connect with me on social media</p>
        </div>
      </div>
    </footer>
  );
