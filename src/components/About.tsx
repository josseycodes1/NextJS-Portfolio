      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-2/3">
            <h3 className="text-2xl font-semibold mb-2 text-josseypink1">
              I am Josephine
            </h3>
            <span className="text-lg text-gray-600 mb-4 block">
              Website designer
            </span>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-2xl text-josseypink1 hover:text-[#624F82] transition-colors"
              >
